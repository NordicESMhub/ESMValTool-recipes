...
if iplot:
    ...
    ax3.coastlines()
    ax3.set_global()
    cs = ax3.contourf(lon, lat, cbf_plot2[:,:]/100, levels=clevs, cmap=plt.cm.RdBu_r, transform=proj)
    ax3.axis(extents)
    ax3.set_title('NorESM2-MM Historical')
    ...
    #plt.show()
    plt.savefig('cbf.png',dpi='figure',format='png')
